...
public class Indexador {
     ...
     */
    protected static String DIR_LIBROS =
                                        //File.separator + "asigDSIC" + File.separator + "libros" + File.separator + "TXT" + File.separator;
            ...
            while (libro.hasNext()) {
                ...
                for (int i = 0; i < words.length; i++) {
                    ...
                    if (esTermino(clave)) {
                        ...
                        if(aux == null){
                            aux = new LEGListaConPI();
                            aux.insertar(ind);
                            indices.insertar(clave, aux);
                        } else{
                            aux.insertar(ind);
                        }
