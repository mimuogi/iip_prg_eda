...
public class ABB<E extends Comparable<E>> {
    ...
    public NodoABB<E> construirEquilibrado(E[] v) {
        return construirEquilibrado(v, 0, v.length-1);
    }
    ...
    protected NodoABB<E> construirEquilibrado(E[] v, int ini, int fin) {
        if (ini > fin) return null;
                ...
                int m = (ini+fin)/2;
                NodoABB mitad = new NodoABB(v[m]);
                mitad.izq = construirEquilibrado(v, ini, m-1);
                mitad.der = construirEquilibrado(v, m+1, fin);
                return mitad;
        }
    }
    ...
    protected NodoABB<E> sucesor(E e, NodoABB<E> actual) {
        ...
        if(actual.dato.compareTo(e) > 0) {
            //Buscas si esta a su izquierda
            NodoABB<E> nodoIzq = sucesor(e, actual.izq);
            return (nodoIzq != null) ? nodoIzq : actual;
        }
        else return sucesor(e, actual.der);
    }
